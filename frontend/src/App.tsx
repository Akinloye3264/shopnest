      ...
      <div className="min-h-screen font-sans selection:bg-brand-accent selection:text-black text-white relative z-10">
        ...
        <main className={user ? "pt-32 lg:pt-56 pb-24 studio-container" : ""}>
          <Routes>
            ...
            <Route path="/profile" element={user ? <Profile user={user} onUpdate={handleProfileUpdate} /> : <Navigate to="/login" />} />
            ...
            <div className="w-full max-w-4xl h-[90vh] md:max-h-[90vh] flex flex-col animate-slide-up">
              ...
              <form onSubmit={askAi} className="mt-4 md:mt-8 flex gap-3">
                <input
                  ...
                  className="flex-1 border-b-4 border-white/10 text-white text-lg md:text-2xl font-black pb-4 pt-2 outline-none focus:border-white transition-colors placeholder:text-white/50 placeholder:font-bold min-w-0"
                />
